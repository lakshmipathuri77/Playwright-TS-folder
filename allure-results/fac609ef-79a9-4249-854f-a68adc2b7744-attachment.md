...
```
Error: apiRequestContext._wrapApiCall: EBUSY: resource busy or locked, open 'C:\Users\lpathuri\OneDrive - Hitachi Vantara\Playwright TS folder\test-results\.playwright-artifacts-1\traces\72acf37390c7188faa57-80415c92ca5edd21d9bd-retry1.trace'
```
        ...
        - generic [ref=e133]:
          ...
          - generic [ref=e173]:
            ...
            - generic [ref=e306]:
              ...
              - generic [ref=e312]:
                - generic [ref=e314]:
                  - link "SAP HANA TDI on Hitachi Virtual Storage Platform G Series and VSP F Series with Hitachi Storage Virtualization Operating System Reference Architecture Guide" [ref=e318] [cursor=pointer]:
                ...
                - generic [ref=e324]:
                  - link "Virtual Storage Platform 5000 Series Hardware Guide" [ref=e328] [cursor=pointer]:
                    - /url: https://docs.hitachivantara.com/r/en-us/mk-98rd9013/latest
                  - generic [ref=e332]: Product Documentation
                - generic [ref=e334]:
                  - link "Protect Oracle Database 12c with Global-Active Device on VSP G Series Best Practices Guide" [ref=e338] [cursor=pointer]:
                ...
                - generic [ref=e344]:
                  - link "Deploy Horizon VDI on Hitachi Virtual Storage Platform One SDS Block Reference Architecture Guide" [ref=e348] [cursor=pointer]:
                ...
                - generic [ref=e354]:
                  - link "SAP HANA Tailored Data Center Integration on Hitachi Virtual Storage Platform E990 and VSP E1090 with Hitachi Storage Virtualization Operating System RF Reference Architecture Guide" [ref=e358] [cursor=pointer]:
                    - /url: https://docs.hitachivantara.com/v/u/en-us/application-optimized-solutions/mk-sl-197
